...
class RplMrHof(Rpl):
    ...
    def update(self, dio):
        ...
        print("UPDATING NEIGHBOR'S RANK INFO...")
    ...
    def _update_neighbor_rank_increase(self, neighbor):
        ...
        if etx > self.UPPER_LIMIT_OF_ACCEPTABLE_ETX:
            print("new ETX Greater than acceptable upper etx limit")
            step_of_rank = None
        else:
            print("new ETX LESS than acceptable upper etx limit")
        ...
        print("rank to be added :"+str(self.rank)+"rank to be added :"+str(etx))
